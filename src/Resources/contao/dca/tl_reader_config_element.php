...
if (\Contao\System::getContainer()->get('huh.utils.container')->isBundleActive('HeimrichHannot\ListBundle\HeimrichHannotContaoListBundle')) {
    $dca['fields'] = array_merge($dca['fields'], [
        ...
        'listModule' => [
            ...
            'exclude' => true,
            'options_callback' => function () {
                if (\Contao\System::getContainer()->has('HeimrichHannot\ListBundle\DataContainer\ModuleContainer')) {
                    return \Contao\System::getContainer()->get('HeimrichHannot\ListBundle\DataContainer\ModuleContainer')->getAllListModules();
                }
